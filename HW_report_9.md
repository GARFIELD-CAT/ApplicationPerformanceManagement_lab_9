...
### 3. Таблица Сравнения Latency (в миллисекундах, мс)

| Операция | Кол-во Записей | A: RandomAccessFile (RAF) | B: FileChannel (Пакетная запись) | C: MappedByteBuffer (Случайная запись) |
| :--- | :--- | :--- | :--- | :--- |
| **Запись** | 10 000 | 0.130 мс | 0.026 мс | 0.030 мс |
| **Запись** | 50 000 | 0.393 мс | 0.024 мс | 0.021 мс |
| **Запись** | 100 000 | 0.643 мс | 0.035 мс | 0.030 мс |
| **Чтение** | 10 000 | 0.104 мс | 0.055 мс | 0.032 мс |
| **Чтение** | 50 000 | 0.282 мс | 0.072 мс | 0.017 мс |
| **Чтение** | 100 000 | 0.512 мс | 0.128 мс | 0.028 мс |

---

### 4. Заключение и Архитектурные Компромиссы
